...
public class PillarAssetsReadScope implements ScopeWithPrivileges {

    protected static final String RESOURCE_URI = "/content/dam/pillar";
    protected static final String SCOPE_NAME = "pillar_assets_read";
    protected static final String DESCRIPTION = "Simple read access scope for assets content.";
