...
public class PillarConfReadScope implements ScopeWithPrivileges {

    protected static final String RESOURCE_URI = "/conf/pillar";
    protected static final String SCOPE_NAME = "pillar_conf_read";
    protected static final String DESCRIPTION = "Simple read access scope for app conf.";
