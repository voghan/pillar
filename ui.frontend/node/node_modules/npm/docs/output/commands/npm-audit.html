...
<section id="content">
  ...
  "keys": [{
    ...
    "key": "{{B64_PUBLIC_KEY}}"
        ...
        <p>Keys response:</p>
        <ul>
            <li><code>expires</code>: null or a simplified extended <!-- raw HTML omitted -->ISO 8601 format
                <!-- raw HTML omitted --> : <code>YYYY-MM-DDTHH:mm:ss.sssZ</code></li>
        ...
        <p>See this <!-- raw HTML omitted -->example key's response from the public npm registry
            <!-- raw HTML omitted --> .</p>
